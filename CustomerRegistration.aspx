...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="First name is required" ControlToValidate="TxtBoxFirstName"></asp:RequiredFieldValidator><br />
            <label for="lastName">LastName: </label>
            <asp:TextBox ID="TxtBoxLastName" runat="server"></asp:TextBox><br />
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Last name is required" ControlToValidate="TxtBoxLastName"></asp:RequiredFieldValidator><br />
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Address is required" ControlToValidate="TxtBoxAddress"></asp:RequiredFieldValidator><br />

            <label for="email">Email: </label>
            <asp:TextBox ID="TxtBoxEmail" runat="server"></asp:TextBox><br />
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Invalid email" ControlToValidate="TxtBoxEmail" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator><br />
